...
PC_PUPPET_B64_CHUNKS := $(sort $(wildcard source/generated/phantom_puppet_pc_assets.c.xz.b64.*))
...
pc-puppet-assets:
	@test -n "$(PC_PUPPET_B64_CHUNKS)"
	@cat $(PC_PUPPET_B64_CHUNKS) | base64 -d > "$(PC_PUPPET_ARCHIVE)"
