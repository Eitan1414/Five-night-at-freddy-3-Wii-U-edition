...
typedef enum MonitorV2TextureId {
    ...
    MONITOR_V2_MUTE_CALL,
    MONITOR_V2_SYSTEM_RESTART,
    MONITOR_V2_EXIT,
    MONITOR_V2_ERROR,
    MONITOR_V2_AUDIO_ERROR,
    MONITOR_V2_VIDEO_ERROR,
    MONITOR_V2_VENT_ERROR,
    MONITOR_V2_PROGRESS_0,
    MONITOR_V2_PROGRESS_1,
    MONITOR_V2_PROGRESS_2,
    MONITOR_V2_PROGRESS_3,
    MONITOR_V2_PROGRESS_4,
